...
## Project Structure
    ...
    ├── kirks_jerk_kitchen_37102  # Django project configurations
...
1. Clone this repo and `cd kirks_jerk_kitchen_37102`
...
2. Clone this repo and `cd kirks_jerk_kitchen_37102`
